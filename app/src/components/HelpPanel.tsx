        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeTab === 'help' && (
            <div className="space-y-4">
              ...
              <a
                href="https://xiaotwu.github.io/OpenJam/guide/collaboration.html"
                target="_blank"
                rel="noopener noreferrer"
                className="block p-4 rounded-lg border hover:border-purple-300 hover:bg-purple-50/10 transition-colors" style={{ borderColor: 'var(--glass-border-strong)' }}
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium" style={{ color: 'var(--text-primary)' }}>Collaboration Guide</h4>
                    <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
                      Real-time collaboration, sharing, and permissions
                    </p>
                  </div>
                </div>
              </a>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium" style={{ color: 'var(--text-primary)' }}>Architecture & API Reference</h4>
                    <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
                      Technical architecture, WebSocket API, and CRDT details
                    </p>
                  </div>
                </div>
              </a>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium" style={{ color: 'var(--text-primary)' }}>Report Issues & Feedback</h4>
                    <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
          ...
          {activeTab === 'about' && (
            <div className="text-center py-8">
              ...
              <div className="flex items-center justify-center gap-4">
                <a href="https://github.com/xiaotwu/OpenJam/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-sm text-purple-600 hover:underline">
                  MIT License
                </a>
                <span className="text-gray-300">•</span>
                <a href="https://github.com/xiaotwu/OpenJam" target="_blank" rel="noopener noreferrer" className="text-sm text-purple-600 hover:underline">
                  GitHub Repository
                </a>
                <span className="text-gray-300">•</span>
                <a href="https://github.com/xiaotwu/OpenJam/blob/main/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer" className="text-sm text-purple-600 hover:underline">
                  Contribute
                </a>
              </div>
            </div>
